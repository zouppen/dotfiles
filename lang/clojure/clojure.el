;; Clojure niceties.
;; See CIDER docs for installation.
...
;; Setup stable cider manually (probably not needed)
;;(add-to-list 'load-path (concat dotfiles-folder "/lang/clojure/cider-0.9.1/"))
;;(require 'cider)
...
(defun my-clojure-mode-hook ()
  ...
  ;;(setq cider-cljs-repl "Weasel")
  )
(add-hook 'clojure-mode-hook 'my-clojure-mode-hook)

(defun my-cider-repl-mode-hook ()
  (define-key cider-repl-mode-map (kbd "C-c C-j") 'cider-figwheel-repl))
